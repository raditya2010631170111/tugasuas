...
class DbProvider extends ChangeNotifier {
  ...
  Future<void> addKontak(Onlineshop onlineshop) async {
    await _dbHelper.insertOnlineshop(onlineshop);
    _getAllOnlineshops();
  }

  Future<void> delOnlineshop(Onlineshop kontak, int position) async {
    await _dbHelper.deleteOnlineshop(onlineshop.idHp!);
    print(kontak.nomor);
    _getAllOnlineshops();
  }

  Future<void> upOnlineshop(Onlineshop kontak) async {
...
class _FormUpdateState extends State<FormUpdate> {
  ...
  void initState() {
    merek = TextEditingController(
        text: widget.onlineshop == null ? '' : widget.onlineshop!.merek);
    spesifikasi = TextEditingController(
        text: widget.onlineshop == null ? '' : widget.kontak!.spesifikasi);
    harga = TextEditingController(
        text: widget.onlineshop == null ? '' : widget.kontak!.harga);
    super.initState();
  }
